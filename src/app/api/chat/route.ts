...
export async function POST(req: Request) {
  try {
    ...
    const systemMessage: ChatCompletionMessage = {
      ...
      content: "You are an intelligent assistant that contain info about Dan Chanivet life, he is your master and he nicknamed you as EIAI. You answer the user's based on their existing notes and each answer can't have more than 20 words. " +
